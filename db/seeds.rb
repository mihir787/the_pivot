...
store1.photos.create(title: "Coral Reefs", description: "A beautiful coral reef", price: 12000, image: open('app/assets/images/coral_fish_store.jpeg')).categories << Category.find(1)
store1.photos.create(title: "Starfish", description: "Panko crusted - Head On - Deep fried prawns.", price: 15000, image: open('app/assets/images/starfish_fish_store.jpeg')).categories << Category.find(1)
store1.photos.create(title: "Jellyfish", description: "Served with spicy soy-sauce and squid ink -O- the day.", price: 2000, image: open('app/assets/images/jellyfish_fish_store.jpg')).categories << Category.find(1)
store2.photos.create(title: "Wedding Dress on Stairs", description: "Bacon ipsum dolor amet corned beef salami jerky pork boudin kevin frankfurter brisket.", price: 5000, image: open('app/assets/images/wedding_dress.jpg')).categories << Category.find(1)
store2.photos.create(title: "Wedding Flowers", description: "Turducken swine ham venison boudin. Biltong ham swine porchetta meatloaf strip steak.", price: 7000, image: open('app/assets/images/flowers_wedding.jpg')).categories << Category.find(2)
store2.photos.create(title: "Wedding Ring", description: "You don't think you should... But you should. And will", price: 1000, image: open('app/assets/images/wedding_ring.jpg')).categories << Category.find(3)
store3.photos.create(title: "Mount Doom", description: "Where are the eagles?! in this stunning photo", price: 5000, image: open('app/assets/images/mount_doom_landscape.jpg')).categories << Category.find(3)
